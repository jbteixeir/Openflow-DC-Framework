...
class VMManager(object):
    ...
    def __init__(self, topology, stats, rules, vmreceiver, inithandler = None, xencommunicator = None):
        ...
        #listen to stat events
        #maybe not, depending if stats are requested periodically or explicitly
        #there should be a flag in stats for that (check it first and act according to that
        log.info("Algorithm = %s, core_policy = %s, agg_policy = %s , edge_policy = %s, host_policy = %s",
